                    ...
                    <?php 
                          ...
                          else
                          {
                            ...
                            while($row=mysqli_fetch_assoc($sql))
                            {
                              ...
                              <td><a href='siswa_dasbor_undang.php?aksi=delete&id=".$row['nipernyo']." onclick='return confirm(\'Yakin\')'><button type='button' class='btn btn-default' aria-label='Left Align'>
