                ...
                <div class="row">
                  ...
                  <table id="contoh" class="table" >
                   <thead>
                    ...
                    <tbody>
                    <?php 
                          $sql = mysqli_query($koneksi, "SELECT * FROM lamaran,perusahaan,siswa where lamaran.nipernyo=perusahaan.nipernyo and lamaran.nisnnyo=siswa.nisnnyo");
                          ...
                          else
                          {
                            ...
                            while($row=mysqli_fetch_assoc($sql))
                            {
                              ...
                              <td>".$row['emaitujuannyo']."</td>
                              <td>".$row['emailpengirimnyo']."</td>
                              
                              <td><a href='siswa_dasbor_undang.php?aksi=delete&id=".$row['npsnyo']." onclick='return confirm(\'Yakin\')'><button type='button' class='btn btn-default' aria-label='Left Align'>
