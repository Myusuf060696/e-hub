                ...
                <div class="row">
                  ...
                  <table id="contoh" class="table" >
                   <thead>
                    ...
                    <tbody>
                    <?php 
                          $sql = mysqli_query($koneksi, "SELECT * FROM undangan");
                          ...
                          else
                          {
                            ...
                            while($row=mysqli_fetch_assoc($sql))
                            {
                              ...
                              <td>".$row['nipernyo']."</td>
                              <td>".$row['nisnnyo']."</td>
                              <td><a href='siswa_dasbor_undang.php?aksi=delete&id=".$row['cirinyo']." onclick='return confirm(\'Yakin\')'><button type='button' class='btn btn-default' aria-label='Left Align'>
