...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Berita Perusahaan</h1>
                ...
                <div class="row">
                  ...
                  <table id="contoh" class="table" >
                   <thead>
                    ...
                    <tbody>
                    <?php 
                          $sql = mysqli_query($koneksi, "SELECT * FROM berita_perusahaan, perusahaan where berita_perusahaan.nipernyo=perusahaan.nipernyo");
