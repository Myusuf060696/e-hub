<?php 
  ...
  $tgl = date('l, d-m-Y');
    ...
    if(isset($_POST['simpan'])){
      ...
      $insert = mysqli_query($koneksi, "INSERT  INTO berita_perusahaan (ciri_beritanyo,judulnyo, dalemannyo,tanggalnyo,nipernyo) values 
      (NULL,'$title','$content','$tgl','$nipernyo')") or die (mysqli_error());
      if($insert)
      {
        //header("Location: index.php");
      }
    ...
    <div class="col-md-3">
        ...
        <div class="kiri" >
           ...
           <a href="perusahaan_detail.php" class="list-group-item">Profil Detail</a>
            ...
            <a href="perusahaan_dasbor_post.php" class="list-group-item active">Posting Berita</a>
