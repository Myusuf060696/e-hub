...
include "../koneksi/koneksi.php";
  ...
  $nipernyo = $_SESSION['perusahaan'];

  // Ini sintaks untuk query data siswa 
  $kueri = mysqli_query($koneksi, "SELECT * FROM perusahaan WHERE nipernyo='$nipernyo' ");
  $data = mysqli_fetch_assoc($kueri);
  $namaperusahaan = $data['namonyo'];
  $foto = $data['gambarnyo'];
  $cirinyo = $data['cirinyo'];
  $alamatnyo = $data['alamatnyo'];
  $websitenyo = $data['websitenyo'];
  $emailnyo = $data['emailnyo'];
  $nomer_hp = $data['nomer_hp'];
  $rinciannyo = $data['rinciannyo'];
  $katorahasio = $data['katorahasio'];
  $kota = $data['kotanyo'];
...
<style>
  ...
  <ul class="nav navbar-nav navbar-right" >
        <li><a href="b.siswa.html" >Siswa</a></li>
...
<div class="kotak-bawah">
    ...
    <div class="col-md-3">
        <div class="kiri">
            <div class="list-group-item active"><h4>Dasbor Perusahaan</h4>
            </div>
        </div>
        <div class="kiri">
                  ...
                  if(isset($_POST['upload'])){
                    ...
                    { 
                      ...
                      if (file_exists("../images/" . $newnamafoto))
                      {
                        ...
                        $up = mysqli_query($koneksi, "UPDATE perusahaan SET gambarnyo='$newnamafoto' WHERE nipernyo='$nipernyo'");
        ...
        <div class="kiri" >
            ...
            <a href="perusahaan_detail.php" class="list-group-item">Profil Detail</a>
            <a href="perusahaan_dasbor.php" class="list-group-item active">Edit profil</a>
            <a href="perusahaan_dasbor_post.php" class="list-group-item">Posting Berita</a>
            <a href="perusahaan_dasbor_undang.php" class="list-group-item">Kirim Undangan</a>
            <a href="perusahaan_dasbor_lamar.php" class="list-group-item">Lamaran</a>
</div>
      ...
      if(isset($_POST['update']))
        {
            ...
            $update = mysqli_query($koneksi, "UPDATE perusahaan SET namonyo='$namonyo', cirinyo='$cirinyo', alamatnyo='$alamatnyo',websitenyo='$websitenyo',emailnyo='$emailnyo',nomer_hp='$nomer_hp', rinciannyo='$rinciannyo' WHERE nipernyo='$nipernyo'") or die (mysqli_error());
     ...
     ?>
             <div class="panel panel-default">
              ...
              <form action="" method="post">
                 <div class="form-group">
                   <label for="nipernyo">NIPER</label>
                   <input type="text" class="form-control" id="NPSN" placeholder="Nomor Pokok Perusahaan" required name="nipernyo" value="<?php echo $nipernyo; ?>" disabled >
                </div>

                  <div class="form-group">
                    <label for="namonyo">Nama Perusahaan</label>
                    <input type="text" class="form-control" id="nama_sekolah" placeholder="Nama siswa" required name="namonyo" value="<?php echo $namaperusahaan; ?>">
                  </div>
                    ...
                    <select name="cirinyo" id="" class="form-control" required>
                      <option value="Industri" <?php if($cirinyo == 'Industri'){ echo 'selected'; } ?> >Industri</option>
                      <option value="Perbankan"  <?php if($cirinyo == 'Perbankan'){ echo 'selected'; } ?> >Perbankan</option>
                      <option value="Pertambangan"  <?php if($cirinyo == 'Pertambangan'){ echo 'selected'; } ?> >Pertambangan</option>
                    </select>
                  </div>

                  <div class="form-group">
                    <label for="alamat">Alamat Perusahaan</label>
                    <textarea class="form-control" id="Alamat" placeholder="<?php echo $alamatnyo; ?>" name="alamatnyo"  ></textarea>
                  </div>

          
                  <div class="form-group">
                    <label for="websitenyo">Website</label>
                    <input type="text" class="form-control" id="websitenyo" placeholder="Website Perusahaan" name="websitenyo" value="<?php echo $websitenyo; ?>">
                  </div>

                  <div class="form-group">
                    <label for="emailnyo">Email </label>
                    <input type="email" class="form-control" id="emailnyo" placeholder="Email Perusahaan" name="emailnyo" value="<?php echo $emailnyo; ?>">
                  </div>

                  <div class="form-group">
                    <label for="nomer_hp">No Telp.</label>
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Nomor Telp" name="nomer_hp" value="<?php echo $nomer_hp; ?>">
                  </div>

                  <div class="form-group">
                    <label for="rinciannyo">Deskripsi</label>
                    <textarea name="rinciannyo" id="" cols="30" rows="10" class="form-control" placeholder="<?php echo $rinciannyo; ?>"></textarea>
                  </div>

                  <div class="form-group">
                    <label for="katorahasio">Password</label>
                    <input type="text" class="form-control" id="katorahasio" placeholder="Password" name="katorahasio" value="<?php echo $katorahasio; ?>" disabled>
                  </div>
                  <br>
        ...
        if(isset($_POST['ganti']))
        {
          ...
          $cek = mysqli_query($koneksi, "SELECT * FROM perusahaan WHERE nipernyo='$nipernyo' AND katorahasio='$passlama'");
            ...
            {
              $pass=$passbaru1;
              $update = mysqli_query($koneksi, "UPDATE perusahaan SET katorahasio='$pass' WHERE nipernyo='$nipernyo'");
