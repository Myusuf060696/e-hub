<?php 
 ...
 <!-- Fungsi Menghapus -->
      ...
      if(isset($_GET['aksi']) == 'delete'){
        $id = $_GET['id'];
        $cek = mysqli_query($koneksi, "SELECT * FROM berita_sekolah WHERE ciri_beritanyo='$id'");
        if(mysqli_num_rows($cek) == 0){
          echo "<script>alert('Data Tidak Ditemukan');history.go(-1);</script>";
        }else{
          $delete = mysqli_query($koneksi, "DELETE FROM berita_sekolah WHERE ciri_beritanyo='$id'");
          if($delete){
...
<div class="kotak-bawah">
    ...
    <div class="col-md-3">
      ...
      <a href="sekolah_dasbor_berita.php" class="list-group-item active">Semua berita</a>
</div>
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">Semua Berita</div>
  <!-- Table -->
  <div style="padding: 10px;">
    <table class="table" id="contoh" >
     ...
     <tr>
      ...
      <tbody>
        <?php 
          $sql = mysqli_query($koneksi,"SELECT * FROM berita_sekolah where npsnyo='$npsnyo'");
          if(mysqli_num_rows($sql)==0)
          {
            ...
            while ($row = mysqli_fetch_assoc($sql)) {
              ...
              <td><a href='sekolah_dasbor_berita.php?aksi=delete&id=".$row['ciri_beritanyo']."'>
...
<form>
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
        <table><tr ><td style="padding:10px"><img style="width:200px" src="../images/def.png" alt="..." class="img-thumbnail">
        <input type="date" class="form-control" id="" placeholder="Tanggal" value="14/11/2016" required>
        <input type="text" class="form-control" id="" placeholder="Judul" value="lomba karya tulis sekolah" required></td>
            
            <td style="width:65%"><label>Isi</label>
                <textarea  class="form-control" rows="10" required>gdugudbjdutgdufvdkfgvefbjeufuefuigdufgudgfdbdfgdfjkbdufd8gfdkjgdgdkgdiygdkjgdigdkgd7gdkgdiugdigdgid7gyk</textarea>
            </td>
