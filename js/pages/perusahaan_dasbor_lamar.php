    ...
    <div class="col-md-3">
        ...
        <div class="kiri" >
           ...
           <a href="perusahaan_detail.php" class="list-group-item">Profil Detail</a>
            ...
            <a href="perusahaan_dasbor_lamar.php" class="list-group-item active">Lamaran</a>
</div>
...
<div class="panel panel-default">
  ...
  <div class="panel-heading">Semua Lamaran</div>
  <!-- Table -->
  <table id="contoh" class="table" >
   <thead>
    ...
    <tbody>
                    <?php 
                          $sql = mysqli_query($koneksi, "SELECT * FROM lamaran, perusahaan where lamaran.nisnnyo=perusahaan.nisnnyo  and nipernyo='$nipernyo'") or die  ;
