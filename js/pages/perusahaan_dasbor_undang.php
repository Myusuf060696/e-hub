<?php 
 ...
 <?php 
  ...
  if(isset($_POST['lamar']))
  {
    ...
    $query = mysqli_query($koneksi,"SELECT nisnnyo FROM siswa where emailnyo='$emailtujuan'");
    $cekemail=mysqli_fetch_assoc($query);
    $nisnnyosiswa = $cekemail['nisnnyo'];
      ...
      (NULL,'$isi','$tgl','$nisnnyosiswa','$emailtujuan','$emailnyos','$nipernyo')") or die (mysqli_error());
      if(!$insert)
      {
          echo "<script>alert('Email Siswa Tidak Terdaftar');history.go(-1);</script>";
      }
...
<div class="kotak-bawah">
    ...
    <div class="col-md-3">
        ...
        <div class="kiri" >
            ...
            <a href="perusahaan_dasbor.php" class="list-group-item ">Edit profil</a>
            <a href="perusahaan_dasbor_post.php" class="list-group-item">Posting Berita</a>
            <a href="perusahaan_dasbor_undang.php" class="list-group-item active">Kirim Undangan</a>
    ...
    <div class="panel-body">
     ...
     <form style="width:80%"  method="post">
            <div class="form-group">
              ...
              <input  type="text" class="form-control" id="" placeholder="" required value="<?php echo $namaperusahaan; ?>" name="namonyo" >
            </div>

            <div class="form-group">
            <label for="exampleInputEmail1">Email </label>
            <input  type="email" class="form-control" id="exampleInputEmail1" placeholder="Email" required value="<?php echo $emailperusahaan; ?>" name="emailnyo" >
           </div>

        <div class="form-group">
    <label for="exampleInputEmail1">Email Siswa</label>
    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Email Siswa" required name="emailtujuan">
  </div>
