...
<div class="kotak-bawah">
  ...
  <div class="col-md-6 col-md-offset-3">
    <div class="thumbnail">
      <img src="../images/pr-c.png" alt="...">
      <div class="caption">
          <p>Fitur untuk Perusahaan yang telah mendaftar dan mendapatkan akun</p>
        <p><a href="perusahaan_masuk.php" class="btn btn-success" role="button"><span class="glyphicon glyphicon glyphicon-ok" aria-hidden="true"></span> Sudah Terdaftar</a> 
      </div>
    </div>
    <div class="thumbnail">
      <img src="../images/pr-x.png" alt="...">
      <div class="caption">
          <p>Fitur Perusahaan untuk mendaftar di e-hub SMK</p>
        <p><a href="perusahaan_daftar.php" class="btn btn-warning" role="button"><span class="glyphicon glyphicon glyphicon-remove" aria-hidden="true"></span> Belum Terdaftar</a> 
      </div>
    </div>
  </div>
</div>          
