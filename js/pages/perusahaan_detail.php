                ...
                <!-- End Modal -->
                  ...
                  <div class="kiri" >
                      <div class="list-group">
                        <a href="perusahaan_detail.php" class="list-group-item active">Profil Detail</a>
...
<div class="kanan" >
    <div class="isi">
             <div class="panel panel-default">
              ...
              <div class="panel-heading"><h4><b>Profil Perusahaan</b></h4></div>
              ...
              <table class="table">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td><?php echo $data['cirinyo']; ?></td>
                  </tr>
                  <tr>
                    <td>Kota/Kabupaten</td>
                    <td>:</td>
                    <td><?php echo $data['kotanyo']; ?></td>
                  </tr>
                  <tr>
                    <td>Alamat</td>
                    <td>:</td>
                  ...
                  <tr>
                    <td>Website</td>
                    <td>:</td>
                    <td><?php echo $data['websitenyo']; ?></td>
                  </tr>
                  <tr>
                    <td>Email</td>
                    <td>:</td>
                  ...
                  <tr>
                    <td>Deskripsi</td>
                    <td>:</td>
                    <td><?php echo $data['rinciannyo']; ?></td>
                  </tr>
                  <tr>
                    <td>Password</td>
                    <td>:</td>
