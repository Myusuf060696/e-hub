...
<div class="kotak-bawah">
      <div class="container-fluid">
          ...
          <div class="row">
              <div class="col-md-3">
                  <div class="kiri">
                      <div class="list-group-item active"><h4>Dasbor Sekolah</h4>
                      </div>
                  </div>
                  <div class="kiri">
                ...
                <!-- End Modal -->
                  ...
                  <div class="kiri" >
                      <div class="list-group">
                        <a href="sekolah_detail.php" class="list-group-item active">Profil Detail</a>
...
<div class="kanan" >
    <div class="isi">
             <div class="panel panel-default">
              ...
              <div class="panel-heading"><h4><b>Profil Sekolah</b></h4></div>
              ...
              <table class="table">
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td><?php echo $data['kotanyo_sekolah']; ?></td>
                  </tr>
                  <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><?php echo $data['alamatnyo_sekolah']; ?></td>
                  </tr>
                  <tr>
                    <td>Website</td>
                    <td>:</td>
                  ...
                  <tr>
                    <td>Email</td>
                    <td>:</td>
                    <td><?php echo $data['emailnyo_sekolah']; ?></td>
                  </tr>

                  <tr>
                    <td>No. Telp</td>
                    <td>:</td>
                    <td><?php echo $data['nomer_hp_sekolah']; ?></td>
                    
                  </tr>
                  <tr>
                    <td>Password</td>
                    <td>:</td>
                    <td><?php echo $data['katorahasio_sekolah']; ?></td>
                  </tr> 
