<?php 
  ...
  $kueri = mysqli_query($koneksi, "SELECT * FROM siswa,sekolah,jurusan WHERE sekolah.npsnyo=siswa.npsnyo and jurusan.ciri_jurusannyo=siswa.ciri_jurusannyo and nisnnyo='$nisn'");
                ...
                <!-- End Modal -->
                  ...
                  <div class="kiri" >
                      <div class="list-group">
                       <a href="siswa_detail.php" class="list-group-item active">Detail Profil</a>
...
<div class="kanan" >
    <div class="isi">
             <div class="panel panel-default">
              ...
              <div class="panel-heading"><h4><b>Profil Siswa</b></h4></div>
              ...
              <table class="table">
                  <tr>
                    <td>NISN</td>
                    <td>:</td>
                    <td><?php echo $data['nisnnyo']; ?></td>
                  </tr>
                  <tr>
                    <td>Nama Siswa</td>
                    <td>:</td>
                    <td><?php echo $data['namonyo']; ?></td>
                    
                  </tr>
                  <tr>
                    <td>Jenis Kelamin</td>
                    <td>:</td>
                    <td><?php echo $data['lanang_betino']; ?></td>
                  </tr>
                  <tr>
                    <td>Tanggal Lahir</td>
                    <td>:</td>
                    <td><?php echo $data['tanggal_lahirnyo']; ?></td>
                  </tr>
                  <tr>
                    <td>Agama</td>
                    <td>:</td>
                    <td><?php echo $data['agamanyo']; ?></td>
                  </tr>

                  <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><?php echo $data['alamatnyo']; ?></td>
                    
                  </tr>
                  <tr>
                    <td>Email  </td>
                    <td>:</td>
                    <td><?php echo $data['emailnyo']; ?></td>
                  </tr> 
                  <tr>
                    <td>No.Telp  </td>
                    <td>:</td>
                    <td><?php echo $data['nohpnyo']; ?></td>
                  ...
                  <tr>
                    <td>Password</td>
                    <td>:</td>
                    <td><?php echo $data['katorahasio']; ?></td>
                  </tr>
                  <tr>
                    <td>Nama Sekolah  </td>
                    <td>:</td>
                    <td><?php echo $data['namo_sekolah']; ?></td>
                  </tr>
                  <tr>
                    <td>Jurusan</td>
                    <td>:</td>
                    <td><?php echo $data['namo_jurusannyo']; ?></td>
                  </tr>
                   <tr>
                    <td>Rata - Rata Nilai</td>
                    <td>:</td>
                    <td><?php echo $data['rerata_nilai']; ?></td>
                  </tr>
            ...
            <?php 
            $kueribahasa_indo = mysqli_query($koneksi, "SELECT * FROM nilai WHERE nisnnyo='$nisn' and ciri_mapelnyo='bahasa_indo'");
            $data = mysqli_fetch_assoc($kueribahasa_indo);
            $bahasa_indo = $data['nilainyo'];
            ?>
            <?php 
            $kuerimatematika = mysqli_query($koneksi, "SELECT * FROM nilai WHERE nisnnyo='$nisn' and ciri_mapelnyo='matematika'");
            $data = mysqli_fetch_assoc($kuerimatematika);
            $matematika = $data['nilainyo'];
            ?>
            <?php 
            $kueribahasa_inggris = mysqli_query($koneksi, "SELECT * FROM nilai WHERE nisnnyo='$nisn' and ciri_mapelnyo='bahasa_inggris'");
            $data = mysqli_fetch_assoc($kueribahasa_inggris);
            $bahasa_inggris = $data['nilainyo'];
            ?>
            <?php 
            $kuerikompetensi_keahlian = mysqli_query($koneksi, "SELECT * FROM nilai WHERE nisnnyo='$nisn' and ciri_mapelnyo='komp_keahlian'");
            $data = mysqli_fetch_assoc($kuerikompetensi_keahlian);
            $komp_keahlian = $data['nilainyo'];
            ?>
          <div class="panel panel-default">
              <!-- Default panel contents -->
              <div class="panel-heading"><h4><b>Daftar Nilai</b></h4></div>
                  <table class="table">
                  <tr>
                    <td>Matematika</td>
                    <td>:</td>
                    <td><?php echo $matematika; ?>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <div class="panel panel-default">
              <!-- Default panel contents -->
              <div class="panel-heading"><h4><b>Daftar Prestasi</b></h4></div>
                  <table class="table">
                  <thead>
                  <tr>
                    <th>No.</th>
