...
<div class="row">
  ...
  <div class="col-xs-12 col-md-12" style="background:#f2f4f7">
     ...
     <div class="kotak"><h5><i>Daftar Perusahaan yang telah terdaftar dalam Web E-Hub SMK</i></h5></div>
    <?php 
        ...
        if(mysqli_num_rows($sql)==0)
        {
          ...
          while ($row = mysqli_fetch_assoc($sql)) {
            ...
            <img src='../images/".$row['logonyo']."'  alt='...' class='objekk'>
            </div>
            <div class='caption'>
              <h4><b>".$row['namonyo']."</b></h4>
              <a href=''><p><b>".$row['cirinyo']."</b></p></a>
              <a href=''><p>".$row['websitenyo']."</p></a>
              <a href=''><p>".$row['kotanyo']."</p></a>

              <div class='alert alert-info' role='alert'><p>Contact : <b>".$row['nomer_hp']."</b></p></div>
